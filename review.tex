...
\abstract{We pose an unsolved problem in autonomous control of
  ...
  review the literature relevant to this problem. Some of these papers
  offer approximately optimal solutions to related problems in
  different domains, while still promising applicability to the
  important scenario considered here.
  ...
  possible ideas for moving the field forward.  Finally, we consider a
...
rescue, and several similar scenarios---notably cyber-security and
precision farming.  Search and rescue clearly relates to the problem
...
being rescued presumably want to be found and will presumably
cooperate with this effort.  But in electronic warfare participants
always aim to keep their locations from the other side. As a result,
